...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    id: 5,
    name: 'Paola',
    textEs: 'Yo me hice 3 ultrasonidos. 14 semanas, 25 semanas, 34 semanas. Y quedamos encantados con el trato, el amor que le tiene a los bebés. Nos dio tranquilidad, seguridad y paz, todo lo explicas súper bien, revisas súper bien a los bebés 🥹 Sin duda alguna para mí es la mejor ginecóloga.',
    textEn: 'I had 3 ultrasounds: 14 weeks, 25 weeks, 34 weeks. And we were delighted with the care, the love she has for babies. She gave us peace of mind, security, and tranquility — you explain everything so well, you check the babies so thoroughly 🥹 Without a doubt, for me she is the best gynecologist.',
    rating: 5,
  },
  {
    id: 6,
    ...
    textEn: 'The doc is an angel on this earth — she helped me and was there when I needed her most during my pregnancy. She discovered that my baby had some issues, she always gave me words of encouragement, supported me in every way she could, and always tried to explain everything as best as possible so I could understand. Simply an exceptional professional in her work. Thank you for the beautiful work you do.',
    rating: 5,
  },
  {
    id: 7,
