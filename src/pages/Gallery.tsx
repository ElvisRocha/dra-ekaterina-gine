...
const galleryImages = [
  ...
  { id: 13, src: 'https://res.cloudinary.com/dcvipikha/image/upload/f_auto,q_auto/v1770786745/v1771898892/consultorio_gx8i9x.jpg', loading: "lazy", category: 'office', alt: 'Consultorio' },
